// $ANTLR 3.5.2 src/analyseurs/projet.g 2026-03-06 17:21:51
...
public class projetParser extends Parser {
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			// src/analyseurs/projet.g:140:19: ( ',' ident )*
			loop32:
			while (true) {
				int alt32=2;
				...
				switch (alt32) {
				case 1 :
					// src/analyseurs/projet.g:140:20: ',' ident
					{
					match(input,13,FOLLOW_13_in_lecture571); 
					pushFollow(FOLLOW_ident_in_lecture573);
					ident();
					state._fsp--;
			...
			match(input,10,FOLLOW_10_in_lecture577); 
			}
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,32,FOLLOW_32_in_ecriture585); 
			match(input,9,FOLLOW_9_in_ecriture587); 
			pushFollow(FOLLOW_expression_in_ecriture589);
			expression();
			state._fsp--;

			// src/analyseurs/projet.g:143:26: ( ',' expression )*
			loop33:
			while (true) {
				int alt33=2;
				...
				switch (alt33) {
				case 1 :
					// src/analyseurs/projet.g:143:27: ',' expression
					{
					match(input,13,FOLLOW_13_in_ecriture592); 
					pushFollow(FOLLOW_expression_in_ecriture594);
					expression();
					state._fsp--;
			...
			match(input,10,FOLLOW_10_in_ecriture598); 
			}
	...
	public final void affouappel() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_ident_in_affouappel606);
			ident();
			state._fsp--;
			...
			switch (alt36) {
				case 1 :
					...
					{
					match(input,16,FOLLOW_16_in_affouappel609); 
					pushFollow(FOLLOW_expression_in_affouappel611);
					expression();
					state._fsp--;
					...
					break;
				case 2 :
					// src/analyseurs/projet.g:146:27: ( effixes ( effmods )? )?
					{
					// src/analyseurs/projet.g:146:27: ( effixes ( effmods )? )?
					int alt35=2;
					...
					switch (alt35) {
						case 1 :
							// src/analyseurs/projet.g:146:28: effixes ( effmods )?
							{
							pushFollow(FOLLOW_effixes_in_affouappel616);
							effixes();
							state._fsp--;

							// src/analyseurs/projet.g:146:36: ( effmods )?
							int alt34=2;
							...
							switch (alt34) {
								case 1 :
									// src/analyseurs/projet.g:146:37: effmods
									{
									pushFollow(FOLLOW_effmods_in_affouappel619);
									effmods();
									state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			{
			match(input,9,FOLLOW_9_in_effixes632); 
			...
			switch (alt38) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_expression_in_effixes635);
					expression();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,13,FOLLOW_13_in_effixes638); 
							pushFollow(FOLLOW_expression_in_effixes640);
							expression();
							state._fsp--;
			...
			match(input,10,FOLLOW_10_in_effixes646); 
			}
	...
	public final void effmods() throws RecognitionException {
		try {
			...
			{
			match(input,9,FOLLOW_9_in_effmods654); 
			...
			switch (alt40) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_ident_in_effmods657);
					ident();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,13,FOLLOW_13_in_effmods660); 
							pushFollow(FOLLOW_ident_in_effmods662);
							ident();
							state._fsp--;
			...
			match(input,10,FOLLOW_10_in_effmods668); 
			}
	...
	public final void expression() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp1_in_expression676);
			exp1();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,46,FOLLOW_46_in_expression680); 
					pushFollow(FOLLOW_exp1_in_expression682);
					exp1();
					state._fsp--;
	...
	public final void exp1() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp2_in_exp1692);
			exp2();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,34,FOLLOW_34_in_exp1695); 
					pushFollow(FOLLOW_exp2_in_exp1697);
					exp2();
					state._fsp--;
		...
		try {
			...
			switch (alt43) {
				case 1 :
					...
					{
					match(input,45,FOLLOW_45_in_exp2707); 
					pushFollow(FOLLOW_exp2_in_exp2709);
					exp2();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_exp3_in_exp2714);
					exp3();
					state._fsp--;
	...
	public final void exp3() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp4_in_exp3722);
			exp4();
			state._fsp--;
			...
			switch (alt44) {
				case 1 :
					...
					{
					match(input,21,FOLLOW_21_in_exp3728); 
					pushFollow(FOLLOW_exp4_in_exp3730);
					exp4();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,20,FOLLOW_20_in_exp3736); 
					pushFollow(FOLLOW_exp4_in_exp3738);
					exp4();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,22,FOLLOW_22_in_exp3744); 
					pushFollow(FOLLOW_exp4_in_exp3746);
					exp4();
					state._fsp--;
				...
				case 4 :
					...
					{
					match(input,23,FOLLOW_23_in_exp3752); 
					pushFollow(FOLLOW_exp4_in_exp3754);
					exp4();
					state._fsp--;
				...
				case 5 :
					...
					{
					match(input,18,FOLLOW_18_in_exp3760); 
					pushFollow(FOLLOW_exp4_in_exp3762);
					exp4();
					state._fsp--;
				...
				case 6 :
					...
					{
					match(input,19,FOLLOW_19_in_exp3768); 
					pushFollow(FOLLOW_exp4_in_exp3770);
					exp4();
					state._fsp--;
	...
	public final void exp5() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_primaire_in_exp5782);
			primaire();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,11,FOLLOW_11_in_exp5788); 
					PtGen.pt(12);
					pushFollow(FOLLOW_primaire_in_exp5792);
					primaire();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,31,FOLLOW_31_in_exp5801); 
					PtGen.pt(12);
					pushFollow(FOLLOW_primaire_in_exp5805);
					primaire();
					state._fsp--;
	...
	public final void exp4() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp5_in_exp4819);
			exp5();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp4825); 
					PtGen.pt(12);
					pushFollow(FOLLOW_exp5_in_exp4829);
					exp5();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,14,FOLLOW_14_in_exp4838); 
					PtGen.pt(12);
					pushFollow(FOLLOW_exp5_in_exp4842);
					exp5();
					state._fsp--;
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire856);
					valeur();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_ident_in_primaire863);
					ident();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,9,FOLLOW_9_in_primaire870); 
					pushFollow(FOLLOW_expression_in_primaire872);
					expression();
					state._fsp--;

					match(input,10,FOLLOW_10_in_primaire874); 
					}
					break;
		...
		try {
			...
			switch (alt48) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_nbentier_in_valeur883);
					nbentier();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,12,FOLLOW_12_in_valeur889); 
					pushFollow(FOLLOW_nbentier_in_valeur891);
					nbentier();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,14,FOLLOW_14_in_valeur898); 
					pushFollow(FOLLOW_nbentier_in_valeur900);
					nbentier();
					state._fsp--;
				...
				case 4 :
					...
					{
					match(input,54,FOLLOW_54_in_valeur907); 
					PtGen.pt(3);
					}
					break;
				case 5 :
					...
					{
					match(input,37,FOLLOW_37_in_valeur914); 
					PtGen.pt(4);
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier931); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident942); 
	...
	public static final BitSet FOLLOW_13_in_lecture571 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture573 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_lecture577 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_32_in_ecriture585 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_ecriture587 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_ecriture589 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_13_in_ecriture592 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_ecriture594 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_ecriture598 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel606 = new BitSet(new long[]{0x0000000000010202L});
	public static final BitSet FOLLOW_16_in_affouappel609 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_affouappel611 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_effixes_in_affouappel616 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_effmods_in_affouappel619 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_effixes632 = new BitSet(new long[]{0x0040202000005660L});
	public static final BitSet FOLLOW_expression_in_effixes635 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_13_in_effixes638 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_effixes640 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_effixes646 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_effmods654 = new BitSet(new long[]{0x0000000000000420L});
	public static final BitSet FOLLOW_ident_in_effmods657 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_13_in_effmods660 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_effmods662 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_effmods668 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp1_in_expression676 = new BitSet(new long[]{0x0000400000000002L});
	public static final BitSet FOLLOW_46_in_expression680 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_exp1_in_expression682 = new BitSet(new long[]{0x0000400000000002L});
	public static final BitSet FOLLOW_exp2_in_exp1692 = new BitSet(new long[]{0x0000000400000002L});
	public static final BitSet FOLLOW_34_in_exp1695 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_exp2_in_exp1697 = new BitSet(new long[]{0x0000000400000002L});
	public static final BitSet FOLLOW_45_in_exp2707 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_exp2_in_exp2709 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp3_in_exp2714 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp4_in_exp3722 = new BitSet(new long[]{0x0000000000FC0002L});
	public static final BitSet FOLLOW_21_in_exp3728 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp3730 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_exp3736 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp3738 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_22_in_exp3744 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp3746 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_23_in_exp3752 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp3754 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_exp3760 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp3762 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_19_in_exp3768 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp3770 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_primaire_in_exp5782 = new BitSet(new long[]{0x0000000080000802L});
	public static final BitSet FOLLOW_11_in_exp5788 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_primaire_in_exp5792 = new BitSet(new long[]{0x0000000080000802L});
	public static final BitSet FOLLOW_31_in_exp5801 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_primaire_in_exp5805 = new BitSet(new long[]{0x0000000080000802L});
	public static final BitSet FOLLOW_exp5_in_exp4819 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_12_in_exp4825 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp5_in_exp4829 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_14_in_exp4838 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp5_in_exp4842 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_valeur_in_primaire856 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire863 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_primaire870 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_primaire872 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_primaire874 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur883 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_12_in_valeur889 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur891 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_14_in_valeur898 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur900 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_54_in_valeur907 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_37_in_valeur914 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier931 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident942 = new BitSet(new long[]{0x0000000000000002L});
}
